...
<div className="form-wrapper">
            <form className="form">
              ...
              <div className="input">
                <UIInput value={state.avaibilityPeriodStart} onChange={handelchange} name="avaibilityPeriodStart" label="AvaibilityPeriodStart" type="text" />
              </div>
              <div className="input">
                <UIInput value={state.avaibilityPeriodEnd} onChange={handelchange} name="avaibilityPeriodEnd" label="AvaibilityPeriodEnd" type="text" />
              </div>
              <div className="input">
