        ...
        <div className="framecontainer-content">
          ...
          <div className="form-wrapper">
            <form className="form">
              ...
              <div className="input">
                <UIInput value={state.weight} onChange={handelchange} name="weight" label="Weight in KG" type="number" />
              </div>
              ...
              <div className="input">
                <UIInput value={state.facebook} onChange={handelchange} name="facebook" label="Facebook" type="name" />
              </div>
              <div className="input">
                <UIInput value={state.instagram} onChange={handelchange} name="instagram" label="Instagram" type="text" />
              </div>
              <div className="input">
                <UIInput value={state.twitter} onChange={handelchange} name="twitter" label="Twitter" type="text" />
              </div>
